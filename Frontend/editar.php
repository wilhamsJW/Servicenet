            ...
            <form action="../Backend/Database/update.php" method="POST">
                ...
                ?>
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" name="endereco" value="<?php echo $endereco ?>" class="form-control" id="rua" aria-describedby="emailHelp" placeholder="Endereço">
                        <small id="emailHelp" class="form-text text-muted"></small>
                    </div>
...
</div> <?php include_once 'includes/footer_inc.php' ?>